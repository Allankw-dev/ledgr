...
from app.routers import auth, students, invoices, payments, terms, fee_structures, parent, users, mpesa, receipts, reports, assistant, announcements, automation, audit_logs, parent_assistant
