...
import { updateFeeStructure } from '../api/school';
import type { SchoolClass, FeeCategory, FeeStructure } from '../types';
...
export function EditFeeStructureForm({ feeStructure, classes, onSuccess, onCancel }: EditFeeStructureFormProps) {
  const {
    register,
    handleSubmit,
    ...
    defaultValues: {
      ...
      class_id: feeStructure.class_id || undefined,
    },
  });
  ...
  async function onSubmit(values: FormValues) {
    try {
      ...
      setError('root', { message: 'Could not save these changes. Check the details and try again.' });
    }
  }
